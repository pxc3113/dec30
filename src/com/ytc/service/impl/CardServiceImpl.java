...
import com.ytc.mapper.CardMapper;
...
public class CardServiceImpl implements CardService {
	 ...
	 */
	@Override
	public Page getAll(Page page, Card card) {
		//把计算出来的开始位置以及每页条数传递到sql中进行查询
		List<Card> list=cardMapper.getAll(page, card);
		page.setList(list);
		return page;
	}

	@Override
	public int getTotalRows(Page page, Card card) {
		//把计算出来的开始位置以及每页条数传递到sql中进行查询
		return cardMapper.getTotalRows(page, card);
	}
